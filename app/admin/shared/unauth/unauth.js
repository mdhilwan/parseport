...
const Unauth = ({whichAdmin}) => {
    ...
    const baseColor = "w-full block mt-5 text-white focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
    const linkClassName = whichAdmin === "super" ? baseColor + " bg-red-600 hover:bg-red-700 " : baseColor + " bg-blue-600 hover:bg-blue-700 "
