        ...
        <div className="mb-4 sticky top-0 bg-slate-300 py-2 flex ps-4">
            ...
            <ControlLink text={"Settings"} url={"/admin"} />
            {
                whichAdmin === 'super' || GetType(email) === 'super' ?
                    <ControlLink text={"Super"} url={`${process.env.NEXT_PUBLIC_BASE_URL}/admin/super`} />
                    : ''
            }
            ...
            <span className="flex">
                {
                    whichAdmin === 'super' || GetType(email) === 'super' ?
                        <ControlLink text={"Add Account"} url={`${process.env.NEXT_PUBLIC_BASE_URL}/admin/super/add`} color="yellow" extraClass="ms-4 border-s rounded-s" />
                        : ''
                }
            </span>
