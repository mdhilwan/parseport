                            ...
                            <div>
                                <div className='w-96 mx-auto'>
                                    <h2 className="text-3xl font-bold tracking-tight text-justify">
                                        ...
                                        Scan this QR code <span className='text-slate-400 text-2xl'>with the phone you want to use to scan</span>
                                    </h2>
                            ...
                            <div>
                                <div className='w-96 mx-auto'>
                                    <h2 className="text-3xl font-bold tracking-tight text-justify">
                                        ...
                                        Or drag & drop the file <span className='text-slate-400 text-2xl'>you can still link your phone later on</span>
                                    </h2>
                                    {
